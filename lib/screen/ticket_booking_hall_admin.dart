...
class TicketBookingHallScreenAdmin extends StatefulWidget {
  @override
...
class _HallBookingScreenState extends State<TicketBookingHallScreenAdmin> {
            ...
            TextButton(
              ...
              onPressed: () {
               ...
               /* loginController.bookTicketPaymentImage(
                ...
                if (totalAmount != "0") {
                  Get.toNamed(
                    Routes.otherEventPaymentScreen,
                    arguments: {
                      "amount": totalAmount,
