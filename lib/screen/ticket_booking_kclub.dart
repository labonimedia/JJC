...
class TicketBookingScreenKclub extends StatefulWidget {
  const TicketBookingScreenKclub({super.key});

  @override
  State<TicketBookingScreenKclub> createState() => _TicketDetailsScreenState();
}

var eIndex;

class _TicketDetailsScreenState extends State<TicketBookingScreenKclub>
  ...
  Future<BhogResponse> getBhogDataApi() async {
    final Uri uri = Uri.parse(Config.baseurlKclub + Config.eventBookingDetails);
  ...
  cancleBooking() async {
    final Uri uri = Uri.parse(Config.baseurlKclub + Config.cancleBooking);
    final response = await http.post(
      uri,
      body: jsonEncode(
          {"uid": getData.read("UserLogin")["id"].toString(), "bid": eventId}),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Builder(
        builder: (context) {
          ...
          return GetBuilder<EventDetailsControllerKclub>(
            builder: (controller) {
              return Visibility(
                visible: isVisible,
                child: eventStatus == "0"
                   ...
                   // if (isPaid == true) {
                      ...
                      if(alloption == "freeForAll"){
                        if (familyCount > 0) {
                          ...
                          loginController.addBhogFreePaymentImageKclub(
                              " ",
                              "no_image",
                              totalAmount,
                              bhogid,
                            ...
                            children: [
                              Text(
                                //"As a member you can book max [ ${maxmember} ]. \n"
                                    "Rs. [ ${memberprice} ] is chargebale for each audience.\n"
                                    //"Rs. [ ${guestsprice} ] is chargebale for each performer.\n"
                        ...
                        children: [
                          ...
                          GestButton(
                            ...
                            onclick: () {
                              Get.to(() => TicketQrCode(
                                  ticketData:
                                  '0;${eventId};${eventName};$eventId;$familyCount;$guestCount;${getData.read("UserLogin")["name"]};${getData.read("UserLogin")["id"].toString()};${responseData.familyList.first.status};$date;$alloption',eventId: eventId,eventype:"kclub" ));
                            },
                          ),
                          /*GestButton(
                                height: 50,
                      ...
                      child: Column(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                "As a registered user can book max [ 15 ] free ${textname}. \n",
                                style: TextStyle(
                                  fontFamily:
                                  FontFamily.gilroyBold,
                                  fontSize: 10,
                          ...
                          GestButton(
                            ...
                            onclick: () {
                              Get.to(() => TicketQrCode(
                                  ticketData:
                                  '${eventId};${eventName};$eventId;$familyCount;$guestCount;${getData.read("UserLogin")["name"]};${getData.read("UserLogin")["id"].toString()};${responseData.familyList.first.status};$date;$alloption', eventId: eventId,eventype:"kclub"));
                            },
                          ),
                        ],
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                GestButton(
                                  ...
                                  onclick: () {
                                    if (totalAddAmount !=
                                      ...
                                      showToastMessage(
                                          "Please Select number of perfomer to add!"
                                              .tr);
                                      /*   loginController.addBhogFreePaymentImage(
                                        " ",
                                        "no_image",
                          ...
                          GestButton(
                            ...
                            onclick: () {
                              Get.to(() => TicketQrCode(ticketData: '${eventId};${eventName};$eventId;$familyCount;$guestCount;${getData.read("UserLogin")["name"]};${getData.read("UserLogin")["id"].toString()};${responseData.familyList.first.status};$date;$alloption',eventId: eventId,eventype:"kclub"));
                            },
                          ),
                        ],
                      ),
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                               // "As a member you can book max [ ${maxmember} ]. \n"
                                    "Rs. [ ${memberprice} ] is chargebale for each audience.\n"
                                   // "Rs. [ ${guestsprice} ] is chargebale for each perfomer.\n"
                                    "${int.parse(eventDetailsController.eventInfo?.eventData?.totalTicket.toString() ?? "0") - int.parse(eventDetailsController.eventInfo?.eventData?.totalBookTicket.toString() ?? "0")} spots left",
                                style: TextStyle(
                                  fontFamily:
                                  FontFamily.gilroyBold,
