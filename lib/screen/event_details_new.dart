...
class EventDetailsScreenNew extends StatefulWidget {
  const EventDetailsScreenNew({super.key});

  @override
  State<EventDetailsScreenNew> createState() => _EventDetailsScreenState();
}

class _EventDetailsScreenState extends State<EventDetailsScreenNew>
                  ...
                  Container(
                    child: Column(
                      ...
                      children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: NetworkImage(
                                                "${Config
                                                    .imageUrl}${eventDetailsController
                                                    .eventInfo
                                                    ?.eventArtist[index]
                                                    .artistImg}"),
                                          ),
                                              ...
                                              onTap: () {
                                                ...
                                                Get.toNamed(
                                                  ...
                                                  arguments: {
                                                    ...
                                                    "image":
                                                    "${Config
                                                        .imageUrl}${restriction
                                                        .restrictionImg}",
                                                  },
                                                );
                                              },
                                              child: Image.network(
                                                "${Config.imageUrl}${restriction
                                                    .restrictionImg}",
                                                height: 150,
                                                width: 150,
                                                fit: BoxFit.fill,
                          ...
                          SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Center(child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final restriction = eventDetailsController
                                      .eventInfo?.eventRestriction
                                      .where((restriction) =>
                                  restriction
                                      .restriction_category ==
                        ...
                        eventDetailsController.eventInfo?.spacialAttraction?.details != null &&
                            eventDetailsController.eventInfo!.spacialAttraction!.details!.isNotEmpty
                            ? SizedBox(
                          height: 10,
                        )
                            : SizedBox(),
                        ...
                        eventDetailsController.eventInfo?.spacialAttraction?.details != null &&
                          ...
                          child: ListView.builder(
                            shrinkWrap: true,
                            itemCount: eventDetailsController
                                .eventInfo?.spacialAttraction?.details?.length,
                            scrollDirection: Axis.horizontal,
                            padding: EdgeInsets.zero,
                            itemBuilder: (context, index) {
                              return  Center(
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    if(eventDetailsController.eventInfo?.spacialAttraction!.details?[index].path != "") {
                                      Get.to(
                                          VideoPreviewScreen(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            children: <Widget>[
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    width:200,
                                                    child:Text(
                                                      eventDetailsController.eventInfo?.spacialAttraction!.details?[index].title ?? "" ,
                                              ...
                                              // Date and Time
                                              Text(
                                                (eventDetailsController.eventInfo?.spacialAttraction?.details?[index].date ?? "") +
                                                    " | " +
                                                    (eventDetailsController.eventInfo?.spacialAttraction?.details?[index].time ?? ""),
                                              ...
                                              SizedBox(
                                                ...
                                                SingleChildScrollView(
                                                  child:Text(
                                                    eventDetailsController.eventInfo?.spacialAttraction!.details?[index].description ?? "",
  ...
  Widget _buildExpandablePuja3(List<Map<String, dynamic>> eventDetailsList,
      int index) {
    return ListView.builder(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              ...
                              softWrap: true,
                              maxLines: null,
                              overflow: TextOverflow.visible, // Adds "..." if the text overflows
                            ),
                          ),
                          SizedBox(width: 8), // Optional: Adds space between the texts
                          Text(
                            "${detail.eTime}",
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: bhogDetail.map((bhogDetails) => ListTile(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text("Please login to your account for booking."),
                              action: SnackBarAction(
                                label: 'Login',
                                onPressed: () {
                                  Get.to(() => MyClubScreen());; // Navigate to login screen
                                },
                              ),
