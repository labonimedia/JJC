...
class EventDetailsScreen1 extends StatefulWidget {
  const EventDetailsScreen1({super.key});

  @override
  State<EventDetailsScreen1> createState() => _EventDetailsScreenState();
}

class _EventDetailsScreenState extends State<EventDetailsScreen1> {
        ...
        builder: (context) {
          return bookStatus == "0"
            ...
            onclick: () {
              ...
              if (_isLoggin == true) {
                eventDetailsController.eventInfo?.eventData?.sponsoreId == getData.read("UserLogin")["club"] ?
                eventDetailsController.eventInfo?.eventData?.category_id =="1" ?
                Get.toNamed(Routes.tikitBookingHallScreen,
                  arguments: {
                    "eventId": eventId,
                ...
                Get.toNamed(Routes.tikitBookingScreen,
                  arguments: {
                    "eventId": eventId,
                    "eventName": eventDetailsController.eventInfo?.eventData?.eventTitle,
                    "date": formatDate(eventDetailsController.eventInfo?.eventData!.eventSdate?? ''),
                ...
                ScaffoldMessenger.of(this.context).showSnackBar(
                  SnackBar(
                    content:
                    Text("You are not member of this centre for booking."),
