...
class KclubEventPaymentScreen extends StatefulWidget {
  @override
  _BhogPaymentState createState() => _BhogPaymentState();
}

class _BhogPaymentState extends State<KclubEventPaymentScreen> {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            "Please pay your ${textname} amount :Rs " + amount,
                            style: TextStyle(
                              color: BlackColor,
                              fontFamily: "Gilroy Bold",
                              fontSize: 16,
                          ...
                          child: GestButton(
                            ...
                            onclick: () {
                              ...
                              if (_selectedTransactionMode == null) {
                                ...
                                loginController.addKclubEventPaymentImage(
                                    base64Image,
                                    "pay_image",
                                    amount,
                                    bhogid,
