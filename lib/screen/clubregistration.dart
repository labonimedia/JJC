...
class ClubRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<ClubRegistrationScreen> createState() => _WelcomeScreenState();
}



class _WelcomeScreenState extends State<ClubRegistrationScreen> {
...
;
  ...
  Future<void> fetchVillages(String district) async {
    final response = await http.get(Uri.parse('http://api.geonames.org/searchJSON?formatted=true&q=$district&featureCode=PPL&maxRows=10&username=demo'));
    if (response.statusCode == 200) {
      Map<String, dynamic> data = json.decode(response.body);
      setState(() {
        villages = data['geonames'].map<String>((village) => village['name'].toString()).toList();
      });
    }
  }
                        ...
                        children: [
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter club name'.tr;
                                }
                                return null;
                              },
                            ),
                            ...
                            child: IntlPhoneField(
                              ...
                              validator: (p0) {
                                if (p0!.completeNumber.isEmpty) {
                                  return 'Please enter club number'.tr;
                                } else {}
                                return null;
                              },
                            ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                SizedBox(
                                  width: Get.width, // Ensures the dropdown takes up available space
                              ...
                              children: [
                                ...
                                style: TextStyle(
                                  ...
                                  color: Colors.black,
                                    ...
                                    validator: (value) {
                                      if (value == null || value.isEmpty) {
                                        return 'Please select district'.tr;
                                      }
                                      return null;
                                    },
                                  ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                style: TextStyle(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'Please enter village/city name'.tr;
                                    }
                                    return null;
                                  },
                                  ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 20),
                                 Text('Club Image',style: TextStyle(
                            ...
                            onclick: () {
                              ...
                              if ((_formKey.currentState?.validate() ?? false) &&
                               ...
                               // signUpController.setUserApiData(cuntryCode,selectedCountry,selectedState,selectedDistrict);
                                signUpController.addClubData(cuntryCode,base64Image,selectedCountry,selectedState,selectedDistrict,"club_image");
