...
class _PayMembershipFeeState extends State<PayMembershipFeeScreen> {
  ...
  // List of key-value pairs (value-label pairs)
  ...
  void initState() {
    super.initState();
    loginController.getLoginApiDataNew(
        getData.read("UserLogin")["ccode"],
        getData.read("UserLogin")["mobile"],
        getData.read("UserLogin")["password"]);
    networkimage1 =
        Config.imageUrl + (getData.read("UserLogin")["membership_photo"] ?? "");
    networkimage2 = Config.imageUrl +
        (getData.read("UserLogin")["reconciliation_photo"] ?? '');
    getData.read("UserLogin") != null
        ? setState(() {
            clubQr = getData.read("clublist")["clubqr"] ?? "";
          })
        : clubQr = "";
    print(getData.read("UserLogin")["membership_photo"] ?? "");
    /*  if(networkimage1 != null   ) {
      _isVisible = false;
    ...
    if ((getData.read("UserLogin")["membership_photo"] ?? "") == "") {
      ...
      setState(() {
        networkimage1 = Config.imageUrl +
            (getData.read("UserLogin")["membership_photo"] ?? "");
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            "Membership Fee is " +
                                getData
                                    .read("UserLogin")["reconciliation_status"],
                            style: TextStyle(
                              color: BlackColor,
                              fontFamily: "Gilroy Bold",
                              fontSize: 16,
                        ...
                        Text(
                          "Kindly Pay immediately to access club services",
                          style: TextStyle(
                            color: BlackColor,
                            fontFamily: "Gilroy Bold",
                            fontSize: 16,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Visibility(
                                ...
                                child: Text(
                                  "Thank you for sharing your payment details. Our team will verify and update your membership details.",
                                  style: TextStyle(
                                    color: BlackColor,
                                    fontFamily: "Gilroy Bold",
                                    fontSize: 14,
                          ...
                          child: GestButton(
                            ...
                            onclick: () {
                              ...
                              if (_selectedTransactionMode == null) {
                                ...
                                loginController.addPaymentImage(
                                    base64Image,
                                    "pay_image",
