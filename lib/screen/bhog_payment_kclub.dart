...
class BhogPaymentScreenKclub extends StatefulWidget {
  @override
  _BhogPaymentState createState() => _BhogPaymentState();
}

class _BhogPaymentState extends State<BhogPaymentScreenKclub> {
                          ...
                          child: GestButton(
                            ...
                            onclick: () {
                              ...
                              if (_selectedTransactionMode == null) {
                                ...
                                loginController.addBhogPaymentImageKclub(
                                    base64Image,
                                    "pay_image",
                                    amount,
                                    bhogid,
