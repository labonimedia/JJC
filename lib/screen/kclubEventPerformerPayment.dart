...
class KclubEventPerformerPayment extends StatefulWidget {
  @override
  _BhogPaymentState createState() => _BhogPaymentState();
}

class _BhogPaymentState extends State<KclubEventPerformerPayment> {
  ...
  String edate = Get.arguments["edate"];
 // String mCount = Get.arguments["mCount"];
  //String gCount = Get.arguments["gCount"];
  String textname = Get.arguments["textname"];
  String eventName = Get.arguments["eventName"];
 // String hall_id = Get.arguments["hall_id"];
  String selected_seat = Get.arguments["selected_seat"];
  String? clubQr;
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Padding(padding: EdgeInsets.only(left: 20.0,right: 20.0) ,child: Text(
                            "Please pay your ${textname} amount : Rs " + amount +" to perform in this event.",
                            style: TextStyle(
                              color: BlackColor,
                              fontFamily: "Gilroy Bold",
                              fontSize: 16,
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                ...
                                return 'Please enter last 5 digit of transaction id'
                                    .tr;
                              }
                              return null;
                            },
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Visibility(
                                ...
                                child: Text(
                                  "Thank you for sharing your payment details. Our team will verify and update your ${textname} details.",
                                  style: TextStyle(
                                    color: BlackColor,
                                    fontFamily: "Gilroy Bold",
                                    fontSize: 14,
                        ...
                        Visibility(
                          ...
                          child: GestButton(
                            ...
                            onclick: () {
                              ...
                              if (_selectedTransactionMode == null) {
                                showToastMessage(
                                    "Please select Transaction Mode".tr);
                              } else if (transactionID.length > 5 || transactionID.length < 5) {
                                showToastMessage('Please enter last 5 digit of transaction id'.tr);
                              }else if (base64Image == null) {
                                showToastMessage("Please select image".tr);
                              } else {
                                loginController.addKclubEventPerformerPaymentImage(
                                    base64Image,
                                    "pay_image",
                                    amount,
                                    eventId,
