...
import 'package:jjcentre/screen/PaymentGateway/FlutterWave.dart';
import 'package:jjcentre/screen/PaymentGateway/InputFormater.dart';
import 'package:jjcentre/screen/PaymentGateway/PaymentCard.dart';
import 'package:jjcentre/screen/PaymentGateway/StripeWeb.dart';
import 'package:jjcentre/screen/PaymentGateway/paytm_payment.dart';
import 'package:jjcentre/screen/home_screen.dart';
import 'package:jjcentre/screen/paypal/flutter_paypal.dart';
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              GetBuilder<EventDetailsController1>(builder: (context) {
                return Container(
                  height: 120,
                  width: Get.size.width,
