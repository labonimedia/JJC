                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          placeholder: "assets/ezgif.com-crop.gif", // Make sure the asset path is correct
                          placeholderFit: BoxFit.cover,
                          placeholderCacheHeight: 100,
                          placeholderCacheWidth: 100,
                          image: eventDetailsController.eventInfo?.eventData?.eventVideoUrls[index] != null
                              ? YoutubePlayer.getThumbnail(
                            videoId: YoutubePlayer.convertUrlToId(
                              eventDetailsController.eventInfo?.eventData?.eventVideoUrls[index] ?? "",
                            ) ??
                                "", // Fallback to empty string if conversion fails
                          )
                              : "https://via.placeholder.com/150", // Fallback to an online default image
                          fit: BoxFit.cover,
                        ),
                      ),
