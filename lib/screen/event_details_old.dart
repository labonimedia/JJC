...
import 'package:magicmate/screen/myclubscreen.dart';
import 'package:magicmate/screen/organizer%20details/organizer_Information.dart';
import 'package:magicmate/screen/organizer%20details/userdetails_screen.dart';
...
import 'package:magicmate/screen/view_sponser.dart';
...
class _EventDetailsScreenState extends State<EventDetailsScreenNew>
  ...
  String formatDate(String dateString) {
    ...
    DateTime parsedDate = DateTime.parse(dateString); // or use DateFormat if not in ISO 8601 format
  ...
  Widget build(BuildContext context) {
    ...
    final creativeStalls = eventDetailsController.eventInfo?.eventRestriction
        .where((restriction) => restriction.restriction_category == 'creativeBazar')
        .toList();
...
/*Padding(
                                ...
                                Container(
                                  ...
                                  child: TabBarView(
                                    ...
                                    children: eventDates
                                        .map((date) =>
                                    //_buildPujaList(date: date))
                                    _buildDetailRowWithButton(date: date))
                                        .toList(),
                                  ),
                                )
                              ],
                        ...
                        if (foodStalls != null && foodStalls.isNotEmpty) ...[
                        ...
                        Padding(
                          ...
                          child: GridView.builder(
                            shrinkWrap: true,
                            itemCount: eventDetailsController.eventInfo?.eventRestriction
                                .where((restriction) => restriction.restriction_category == 'foodStall')
                                .length ??
                                0,
                            physics: NeverScrollableScrollPhysics(),
                            ...
                            itemBuilder: (context, index) {
                              final restriction = eventDetailsController.eventInfo?.eventRestriction
                                  .where((restriction) => restriction.restriction_category == 'foodStall')
                                  .toList()[index];
                        ...
                        SizedBox(height: 5,),
                        if (creativeStalls != null && creativeStalls.isNotEmpty) ...[
                          // Show "Fun Zone" only if there are Fun Zone stalls available
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
                        ...
                        if (funZoneStalls != null && funZoneStalls.isNotEmpty) ...[
                          // Show "Fun Zone" only if there are Fun Zone stalls available
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
...
/*Widget _buildPujaList({required String date}) {
  ...
  Widget _buildExpandableEventList(List<Map<String, dynamic>> eventDetailsList) {
    return ListView.builder(
      itemCount: eventDetailsList.length,
      itemBuilder: (context, index) {
              ...
              Column(
                ...
                children: cultural
                  ...
                  title: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(culturalDetail.description,
                          style: TextStyle(fontSize: 14)),
                      Text("${culturalDetail.eTime}",
                          style: TextStyle(fontSize: 12)),
                    ],
                  ),
                ))
